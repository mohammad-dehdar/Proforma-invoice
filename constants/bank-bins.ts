// داده‌های پیش‌شماره کارت‌های بانکی ایران
// منبع: wikiplast.ir (فهرست پیش‌شماره کارت شتابی بانک‌های کشور)
 ...
 * @param cardNumber شماره کارت (با یا بدون خط تیره)
 * @returns نام بانک یا null در صورت عدم تشخیص
 */
