...
export const DiscountTax = () => {
    ...
    return (
        <div className="bg-gray-800 rounded-lg shadow-2xl p-6 mb-6">
            <h2 className="text-xl font-bold text-blue-400 mb-4 text-right">تخفیف و مالیات</h2>
            ...
            <div>
                ...
                <textarea
                    ...
                    className="w-full bg-gray-700 text-white rounded px-4 py-2 border border-gray-600 focus:border-blue-500 focus:outline-none min-h-[100px]"
